...
result = optimalAngle.Angle(d1,d2,n,v_sand,n)
...
print("Если спасатель начнёт движение под углом 'цикла', равным ",
      round(result[0]) , "градусам, он достигнет утопащего через " , round(result[1],1) ,"секунды")
